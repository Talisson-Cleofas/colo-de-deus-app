...
const AgendaMissionariaPage = lazy(() =>
  import('./pages/AgendaMissionariaPage').then((m) => ({ default: m.AgendaMissionariaPage })),
);
const AuditPage = lazy(() => import('./pages/AuditPage').then((m) => ({ default: m.AuditPage })));
const AttendancePage = lazy(() =>
  import('./pages/AttendancePage').then((m) => ({ default: m.AttendancePage })),
);
const BirthdaysPage = lazy(() =>
  import('./pages/BirthdaysPage').then((m) => ({ default: m.BirthdaysPage })),
);
const CommunitiesPage = lazy(() =>
  import('./pages/CommunitiesPage').then((m) => ({ default: m.CommunitiesPage })),
);
const CommunityDetailPage = lazy(() =>
  import('./pages/CommunityDetailPage').then((m) => ({ default: m.CommunityDetailPage })),
);
...
const LectioPage = lazy(() =>
  import('./pages/LectioPage').then((m) => ({ default: m.LectioPage })),
);
...
const OrganizationDashboardPage = lazy(() =>
  import('./pages/OrganizationDashboardPage').then((m) => ({
    default: m.OrganizationDashboardPage,
  })),
);
...
const TechnicalAdminPage = lazy(() =>
  import('./pages/TechnicalAdminPage').then((m) => ({ default: m.TechnicalAdminPage })),
);
        ...
        <Suspense fallback={<AppLoadingScreen />}>
          <Routes>
            ...
            <Route
              ...
              element={protect(<AgendaMissionariaPage />, Permission.MISSIONARY_AGENDA_READ)}
            />
            <Route path="/eventos" element={protect(<EventsPage />, Permission.EVENTS_READ)} />
            <Route
              path="/eventos/:id"
              element={protect(<EventDetailPage />, Permission.EVENTS_READ)}
            />
            ...
            <Route
              path="/membros/:id"
              element={protect(<MemberProfilePage />, Permission.MEMBERS_READ)}
            />
            <Route
              path="/missoes"
              element={
            ...
            <Route
              path="/celulas"
              element={protect(<CommunitiesPage type="CELL" />, Permission.CELLS_READ)}
            />
            <Route
              path="/mapa-celulas"
              element={protect(<Navigate to="/celulas?tab=mapa" replace />, Permission.CELLS_READ)}
            />
            <Route
              path="/cenaculos"
              element={protect(<CommunitiesPage type="CENACLE" />, Permission.CENACLES_READ)}
            />
            <Route
              path="/comunidades/:id"
              element={protectAny(<CommunityDetailPage />, [
                Permission.CELLS_READ,
                Permission.CENACLES_READ,
              ])}
            />
            <Route
              path="/comunidades/:id/presenca"
              element={protectAny(<AttendancePage />, [
                Permission.CELLS_MANAGE,
                Permission.CENACLES_MANAGE,
              ])}
            />
            <Route
              path="/notificacoes"
              element={protect(<NotificationsPage />, Permission.DASHBOARD_READ)}
            />
            <Route
              path="/aniversarios"
              element={protect(<BirthdaysPage />, Permission.MEMBERS_READ)}
            />
